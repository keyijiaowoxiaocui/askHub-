	...
	<div class="app-top-nav">
		...
		<div class="search_box">
			...
			<router-link to="/homeSearchResult">
				<a v-if="getrouter.go_router == '/'" class="search_btn" @click="homeSearch(inpval)"></a>
			</router-link>
			<!-- 商品页面搜索框 -->
			<a
			...
			></a><span class="iconfont icon-sousuo" style="font-size: 26px;margin-top: 5px;"></span>
			<a
			...
			></a>
			<router-link to="/homeSearchResult">
				<a v-if="getrouter.go_router.includes('article_details')" class="search_btn" @click="homeSearch(inpval)"></a>
			</router-link>
		</div>
		<ul id="right">
			<router-link to="/msg">
