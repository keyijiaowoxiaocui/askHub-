				...
				<div class="article">
					<div class="article_article">
						...
						<div class="content">
							...
							<el-main>
								<h1 id="-">
									一级目录luuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu
								</h1>
								<br />
								<br />
								<br />
				...
				<div class="author_information">
					...
					<div class="operate_btn" v-if="usId != author_id">
						...
						<a href="javascript:;" class="link_message">
							<div class="private_message" @click="no_message">
								私信
							</div>
						</a>
					</div>
...
export default {
	...
	setup() {
		...
		const jump = (index) => {
			const jumpElements = document.querySelectorAll('h1,h2,h3,h4,h5,h6');
			const total = jumpElements[index].offsetTop - 80;
		...
		const selectAllTitle = () => {
			...
			navList.value = Array.from(title).map((item) => {
				return {
					name: item.innerHTML,
					lev: 'lev' + item.localName.substring(1),
			...
			nextTick(() => {
				setTimeout(() => {
					...
					for (let i = navs.length - 1; i >= 0; i--) {
						const currentItem = navList.value[i];
						const navElement = document.querySelector(
							'#' + navs[i].id
						);
						navElement.style.padding = '0';
						if (currentItem.lev === 'lev1') {
							navElement.style.paddingLeft = '20px';
						} else if (currentItem.lev === 'lev2') {
							navElement.style.paddingLeft = '35px';
						} else if (currentItem.lev === 'lev3') {
							navElement.style.paddingLeft = '50px';
						} else if (currentItem.lev === 'lev4') {
							navElement.style.paddingLeft = '65px';
							navElement.style.fontWeight = '400';
						} else if (currentItem.lev === 'lev5') {
							navElement.style.paddingLeft = '80px';
							navElement.style.fontWeight = '400';
						}
					}
				});
