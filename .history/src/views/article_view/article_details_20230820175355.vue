<template>
	...
	<div class="position_main w">
		<div class="sidebar_icon">
			<div class="icon icon-xiai" @click="changeColor">
				<span
			...
			<div class="icon center_container">
				<span class="iconfont icon-kaoyan"></span>
			</div>
		</div>
				...
				<!-- <div class="commodity_recommendation">
						...
						<div class="commodity">
							<div class="commodity1">
								<div class="image">
									<img
										src="https://gw.alicdn.com/bao/uploaded/i2/4087729500/O1CN01JG4Pyx2K33Rs1PykF_!!0-item_pic.jpg_300x300q90.jpg_.webp"
										alt="图片"
									/>
								</div>
								<div class="commodity_name_price">
									<div class="commodity_title_box">
										<span class="commodity_title"> </span>
									</div>
									<span>神三元</span>
				...
				<div class="author_information">
					...
					<div class="read">
						<span class="read_read"
							><span class="iconfont icon-zhengkaiyanjing"></span
...
.right_sidebar {
	...
	width: 300px;
	height: auto;
	box-shadow: 0 0 5px #585e58; /* 调整阴影大小和颜色透明度 */
	border-radius: 4px;
}
.author_information {
	width: 300px;
