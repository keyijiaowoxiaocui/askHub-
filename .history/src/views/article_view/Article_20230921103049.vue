    ...
    <div class="sidebar">
      ...
      >
        <button
          ...
          :class="{ active: isActive_value === item.categoryId }"
...
export default {
  ...
  setup () {
    ...
    const onLinkClick = async (id) => {
      ...
      isActive.value = id
      isActive_value = isActive.value
      console.log(isActive.value, isActive_value, isActive_value === isActive.value, isActive_value === item.categoryId)
    }
    onMounted(async () => {
