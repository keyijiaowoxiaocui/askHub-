<template>
    <div class="top_nav_wrapper">
        ...
        <div class="top_nav_right">
            ...
            <el-button type="primary" @click="drawerBT">
                发布
            </el-button>
                        ...
                        <div class="set_label">
                            <el-select v-model="form.labelsId" multiple placeholder="请添加搜索标签">
                                <el-option v-for="item in options"
                                    v-show="form.category == item.category_id && form.labelsId.length < 3"
            ...
            <a href="javascript:;" class="right_a">
                <img src="https://p3-passport.byteimg.com/img/mosaic-legacy/3793/3131589739~64x64.awebp" alt="">
            </a>
        </div>
    </div>
    <div class="form_wrapper">
        <form class="form_main" method="post">
            <div class="tit">
                <textarea type="text" placeholder="请输入标题……" v-model="form.title" @input="titL"
...
import { ref } from 'vue'
import { getCategory, upload, subArticle_a, getArticleTag_a, saveArticleDraft_a, deleteArticleDraftById_a } from '@/api/ArticleApis.js'
