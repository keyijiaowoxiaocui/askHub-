<template>
    <AppTopNav />
    <div>
        <el-card class="container" v-for="(item, index) in article.searchResult" @click="goDetail(index)"
            style="background-color: #070501;border-bottom: #070501;border-left: #070501;border-right: #070501;height: 150px;">
            <div>
                这里填什么啊
        ...
        <el-card class="container" v-if="article.searchResult == ''"
            style="background-color: #070501;border-bottom: #070501;border-left: #070501;border-right: #070501;">
            <h2>没有该内容</h2>
        </el-card>
    </div>
</template>
